...
class MLP(torch.nn.Module):
    def __init__(self):
        ...
        self.register_parameter('lambda_1', nn.Parameter(torch.tensor(0.8),requires_grad=True).to(device))
        self.register_parameter('lambda_2', nn.Parameter(torch.tensor(-6.0),requires_grad=True).to(device))
...
for i in range(epochs):
    ...
    opt.step()
    if i % 100 == 0:
        print("epoch:",i,"l:",l, "lamda:",u.lambda_1)
